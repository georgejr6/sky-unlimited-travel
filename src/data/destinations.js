export const destinationsData = {
  ...
  orlando: {
    ...
    subtitle: "Theme Park Capital of the World",
  ...
  cancun: {
    title: "Cancun, Mexico",
    subtitle: "Gateway to the Mayan World",
  ...
  vancouver: {
    title: "Vancouver, BC",
    subtitle: "Ocean Meets Mountains",
